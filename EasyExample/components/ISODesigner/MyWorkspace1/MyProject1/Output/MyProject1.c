...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 10, 0, 
		...
		XYREF(InputString_8000, 25, 153),
		XYREF(InputString_8001, 216, 158),
		XYREF(Button_MinusMinus, 400, 320),
		XYREF(Button_PlusPlus, 400, 400),
		XYREF(Container_Gesamtzaehler, 205, 5),
		XYREF(Container_Tageszaehler, 5, 5),
		XYREF(Button_6004, 405, 32),
		XYREF(Button_6005, 407, 113),
	...
	ID(Button_6004), TYPEID_BUTTON, WORD(64), WORD(63), 249, 249, 1, 0, 1, 2, 
		XYREF(OutputString_links, -4, 18),
		MACRO(EV_KEYPRESS, Macro_2),
		MACRO(EV_KEYRELEASE, Macro_4),
	ID(Button_6005), TYPEID_BUTTON, WORD(68), WORD(60), 249, 249, 1, 0, 1, 2, 
		XYREF(OutputString_rechts, -4, 16),
		MACRO(EV_KEYPRESS, Macro_3),
		MACRO(EV_KEYRELEASE, Macro_5),
	ID(InputString_8000), TYPEID_INSTR, WORD(59), WORD(26), COLOR_SILVER, ID(FontAttributes_23000), 
		ID(ID_NULL), 2, ID(ID_NULL), 0, 4, 'L', 'e', 'c', 'k', 1, 0, 
	ID(InputString_8001), TYPEID_INSTR, WORD(56), WORD(21), COLOR_SILVER, ID(FontAttributes_23000), 
	...
	ID(OutputString_links), TYPEID_OUTSTR, WORD(64), WORD(20), COLOR_WHITE, ID(FontAttributes_23003), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_rechts), TYPEID_OUTSTR, WORD(68), WORD(20), COLOR_WHITE, ID(FontAttributes_23003), 1,
	...
	ID(FontAttributes_23000), TYPEID_FONTATTR, COLOR_BLACK, 3, 0, 1, 0, 
