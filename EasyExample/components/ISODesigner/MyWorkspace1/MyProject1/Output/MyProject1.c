...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(Macro_S2), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_S2), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(100), WORD(500)
	ID(Macro_S1), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_Home), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 2, WORD(493), WORD(100), WORD(500)
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 8, 0, 
		...
		XYREF(Button_S2, 413, 67),
	ID(DataMask_S2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_S1, 140, 106),
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(55), WORD(65), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_s2, -4, 19),
		MACRO(EV_KEYRELEASE, Macro_S2),
	ID(Button_S1), TYPEID_BUTTON, WORD(87), WORD(85), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S1, -4, 29),
		MACRO(EV_KEYRELEASE, Macro_S1),
	...
	ID(OutputString_s2), TYPEID_OUTSTR, WORD(55), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_S1), TYPEID_OUTSTR, WORD(87), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
