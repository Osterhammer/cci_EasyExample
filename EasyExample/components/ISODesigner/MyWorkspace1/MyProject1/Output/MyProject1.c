...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 11, 0, 
		...
		XYREF(OutputString_11006, 211, 224),
		XYREF(OutputString_11000, 13, 232),
		XYREF(Meter_Tageszaehler, 400, 240),
		XYREF(Button_MinusMinus, 400, 320),
		XYREF(Button_PlusPlus, 400, 400),
		XYREF(Container_Gesamtzaehler, -4, -8),
		XYREF(Container_Tageszaehler, 185, -5),
		XYREF(OutputString_ZielErreicht, 500, 150),
		XYREF(Button_6004, 385, 14),
		XYREF(Button_6005, 386, 95),
	...
	ID(Button_6004), TYPEID_BUTTON, WORD(89), WORD(72), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11007, -4, 22),
		MACRO(EV_KEYPRESS, Macro_1),
	ID(Button_6005), TYPEID_BUTTON, WORD(87), WORD(66), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11008, -4, 19),
	...
	ID(OutputString_11000), TYPEID_OUTSTR, WORD(116), WORD(34), COLOR_WHITE, ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(9), 'n', 'i', 'c', 'h', 't', ' ', 'g', 'u', 't', 0,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(118), WORD(35), COLOR_WHITE, ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(8), 's', 'e', 'h', 'r', ' ', 'g', 'u', 't', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(89), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), '1', '.', ' ', ' ', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(87), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
